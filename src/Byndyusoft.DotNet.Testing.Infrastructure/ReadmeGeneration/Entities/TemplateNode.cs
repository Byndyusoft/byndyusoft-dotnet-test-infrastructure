...
internal class TemplateNode
{
    ...
    /// <summary>
    ///     Возвращает порядковый номер категории для сортировки
    ///     Сортировка выполняется сначала по порядковому номеру, а затем по имени по алфавиту
    /// </summary>
    /// <remarks>
    ///     Сортировка категорий:
    ///     - категории, которые есть в шаблоне, выводятся в топе сортировки согласно порядку в шаблоне
    ///     - категории, которых нет в шаблоне, выводятся после шаблонных и сортируются по алфавиту
    ///     - категории с пустым именем, выводятся самыми последними 
    /// </remarks>
    ...
    /// <summary>
    ///     Возвращает порядковый номер подкатегории для сортировки
    ///     Сортировка выполняется сначала по порядковому номеру, а затем по имени по алфавиту
    /// </summary>
    /// <remarks>
    ///     Сортировка категорий:
    ///     - подкатегории, которые есть в шаблоне, выводятся в топе сортировки согласно порядку в шаблоне
    ///     - подкатегории, которых нет в шаблоне, выводятся после шаблонных и сортируются по алфавиту
    ///     - подкатегории с пустым именем, выводятся самыми последними
    ///     - подкатегории в пустой категории сортируюся по алфавиту
    ///     - подкатегории в категории без шаблона сортируются по алфавиту
    /// </remarks>
    public int GetSubCategoryOrder(string? categoryName, string? subCategoryName)
    {
        // подкатегории в пустой категории сортируем просто по алфавиту
        if (string.IsNullOrWhiteSpace(categoryName))
            return 0;
        ...
        // подкатегории с пустым именем в шаблонной категории выводятся самыми последними
        if (string.IsNullOrWhiteSpace(subCategoryName))
        ...
        // подкатегории без шаблона в шаблонной категории выводятся после шаблонных и сортируются по алфавиту
        if (subCategory is null)
            return category._children.Count;

        // шаблонные подкатегории выводятся в топе и сортируются согласно порядку в шаблоне
